...
export default function AssignmentClient({ assignmentId, initialAssignment }: AssignmentClientProps) {
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              ...
              {isPastDue && (
                <span className="ml-2 font-semibold text-red-600">(Past Due)</span>
              )}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="prose max-w-none dark:prose-invert" dangerouslySetInnerHTML={{ __html: assignment.description || '' }} />
          </CardContent>
        </Card>
              ...
              <Card>
                ...
                <CardContent>
                  {hasSubmitted ? (
                    ...
                    <div>
                      <p className={isPastDue ? 'text-red-600' : 'text-yellow-600'}>
                        {isPastDue 
                  ...
                  <div className="mt-4">
                    ...
                    >
                      {hasSubmitted ? 'View/Update Submission' : 'Submit Assignment'}
                    </Button>
                  </div>
                </CardContent>
              </Card>
